function [ c, ceq ] = nonlinear_constraint_func2New( dv, Parameters )
...
%   violation
    ...
    c_stance = stanceConstraintsNew(dv, Parameters);
    
    %Flight collocation constraints
    c_flight = flightConstraintsNew(dv, Parameters);
...
%     eqCon(4:6,2) = dv(4:6,stanceEnd) - dv(4:6, stanceEnd+1);
    ...
    eqCon(2:8,3) = dv(2:8,end) - (dv(2:8,1) +...
        [Parameters.deltah 0 Parameters.deltav 0 0 0 0]');
