...
axis([0,1, -60, 60]); xlabel('Normalized Time'); ylabel('xcop')
...
while results_sorted_var{i}.param.(varName) < varmaxplot
   ...
   if results_sorted_var{i}.param.flag > 0
        ...
        zeta = results_sorted_var{i}.param.c/ (2 * sqrt(results_sorted_var{i}.param.k * results_sorted_var{i}.param.m));
        ankleF = results_sorted_var{i}.param.transmission_ankle * ankle_response .*...
