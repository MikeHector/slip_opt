...
delta_damping = 1;
damping_values = 0:delta_damping:400;
...
load('D:\Documents\DRL\slip_opt\opt_results\no_damp_baseline.mat') % load('C://Users/mike-/Documents/DRL/collocation/opt_results/no_damp_baseline.mat')
opt_seed = optimized;
...
while damping < 300
    ...
    if (opt_results.flag <= 0) && ((damping_values(i) - damping_values(i - 1)) > 1e-6)
