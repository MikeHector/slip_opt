...
hk = R.T / R.param.N;
W_tot_leg = 1 + R.param.R_leg ./ ((R.param.transmission .* R.dr0).^2 * hk);
W_tot_ankle = 1 + R.param.R_ankle .* R.r.^4 ./...
    ((R.param.transmission_ankle .* (R.x .* R.dy - R.y .* R.dx)).^2 .* hk);
figure; plot(R.t, W_tot_leg); hold on; plot(R.t, W_tot_ankle);
